...
以下のSQLコマンドをSupabaseのSQLエディタで実行してください。
...
データベースの準備ができたら、アプリケーションをデプロイしてください：
...
- もし権限エラーが発生した場合は、RLSを無効にしてあることを確認してください
- テーブルが既に存在するエラーが出た場合は、`CREATE TABLE IF NOT EXISTS`が正しく使われているか確認してください