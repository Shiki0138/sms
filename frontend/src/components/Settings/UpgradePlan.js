...
const UpgradePlan = () => {
    ...
    const planFeatures = {
        light: [
            ...
            { icon: 'realtime', text: 'ドラッグ&ドロップ予約', included: true },
            { icon: 'realtime', text: '繰り返し予約', included: true },
        ...
        premium_ai: [
            ...
            { icon: 'messaging', text: '無制限一括送信', included: true },
            { icon: 'export', text: '全形式無制限エクスポート', included: true },
