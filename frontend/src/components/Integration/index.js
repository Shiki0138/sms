...
// Utility Functions
export const formatHotPepperDate = (dateString) => {
    try {
...
export const validateHotPepperCSV = (csvData) => {
    const errors = [];
    const warnings = [];
    if (csvData.length < 2) {
...
export const calculateMatchConfidence = (hotpepperRecord, existingCustomer) => {
    let confidence = 0;
...
export const generateIntegrationReport = (stats) => {
    const lines = [
